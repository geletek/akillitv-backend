    ...
    <div class="card-body">
        <div class="row">
            ...
            <div class="col-sm-7 pull-right">
                <?php echo $__env->make('backend.auth.role.includes.header-buttons', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
            </div><!--col-->
        </div><!--row-->
            ...
            <div class="col">
                <div class="table-responsive">
                    <table class="table">
                        <thead>
                        <tr>
                            <th><?php echo e(__('labels.backend.access.roles.table.role')); ?></th>
                            <th><?php echo e(__('labels.backend.access.roles.table.permissions')); ?></th>
                            <th><?php echo e(__('labels.backend.access.roles.table.number_of_users')); ?></th>
                        ...
                        <?php $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td>
                                    <?php if($role->id == 1): ?>
                                        <?php echo e(__('labels.general.all')); ?>
