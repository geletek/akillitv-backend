        ...
        <div class="row">
            <div class="col-sm-5">
                <h4 class="card-title mb-0">
                    ...
                    <small class="text-muted"><?php echo e(__('labels.backend.access.users.deleted')); ?></small>
                </h4>
            </div><!--col-->
        </div><!--row-->
            ...
            <div class="col">
                <div class="table-responsive">
                    <table class="table">
                        ...
                        <?php else: ?>
                            <tr><td colspan="9"><p class="text-center"><?php echo e(__('strings.backend.access.users.no_deleted')); ?></p></td></tr>
                        <?php endif; ?>
                        </tbody>
                    </table>
                </div>
