<?php $__env->startSection('title', app_name() . ' | ' . __('labels.backend.video.category.management')); ?>
                    ...
                    <div class="row">
                        <div class="col-sm-5">
                            <h4 class="card-title mb-0">
                                <?php echo e(__('labels.backend.video.category.management')); ?> <small class="text-muted"><?php echo e(__('labels.backend.video.category.active')); ?></small>
                            </h4>
                        </div><!--col-->

                        <div class="col-sm-7">
                            <?php echo $__env->make('backend.video.category.includes.header-buttons', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                        </div><!--col-->
                    </div><!--row-->
