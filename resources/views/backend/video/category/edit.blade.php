...
@section ('title', __('labels.backend.video.category.management') . ' | ' . __('labels.backend.video.category.edit'))
...
@section('content')
{{ html()->modelForm($category, 'PATCH', route('admin.video.category.update', $category->id))->class('form-horizontal')->open() }}
