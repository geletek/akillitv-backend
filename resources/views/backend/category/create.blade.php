    ...
    {{ html()->form('POST', route('admin.category.store'))->class('form-horizontal')->open() }}
      <div class="m-portlet m-portlet--creative m-portlet--first m-portlet--bordered-semi">
          ...
          <div class="m-portlet__head">
                    ...
                    {{ __('labels.backend.category.management') }} <small>{{ __('labels.backend.category.create') }}</small>
    						</h3>
    					</div>
    				</div>
    			</div>
                  ...
                  <div class="row mt-4 mb-4">
                      <div class="col">
                          <div class="form-group row">
                              {{ html()->label(__('validation.attributes.backend.category.title'))->class('col-md-2 form-control-label')->for('title') }}
                          ...
                          <div class="form-group row">
                          {{ html()->label(__('validation.attributes.backend.category.description'))->class('col-md-2 form-control-label')->for('description') }}
                          ...
                          <div class="form-group row">
                              {{ html()->label(__('validation.attributes.backend.category.active'))->class('col-md-2 form-control-label')->for('active') }}
                              <div class="col-md-10">
